...
import com.quico.tech.databinding.ActivityMaintenanceListBinding
import com.quico.tech.viewmodel.SharedViewModel

class MaintenanceListActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMaintenanceListBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMaintenanceListBinding.inflate(layoutInflater)
