...
class RequestOld : AppCompatActivity() {
        ...
        binding.apply {
            ...
            requestPhotoRecyclerViewAdapter = RequestPhotoRecyclerViewAdapter(object :
              ...
              /*  override fun onAddPhoto(position: Int, currentPhoto: PhotoService) {
                ...
                override fun onAddPhoto(position: Int, currentPhoto: RequestActivity.PhotoService) {
            ...
            recyclerView.layoutManager = GridLayoutManager(this@RequestOld, 2)
        ...
        binding.apply {
            ...
            recordView.setOnRecordListener(object : OnRecordListener {
                ...
                override fun onCancel() {
                    stopRecording(true)
                    Toast.makeText(this@RequestOld,"cancel",Toast.LENGTH_LONG).show()
            ...
            recordView.setRecordPermissionHandler(RecordPermissionHandler {
                ...
                val recordPermissionAvailable = ContextCompat.checkSelfPermission(
                    this@RequestOld, Manifest.permission.RECORD_AUDIO
                ) == PermissionChecker.PERMISSION_GRANTED
                if (recordPermissionAvailable) {
                    return@RecordPermissionHandler true
                }
                ActivityCompat.requestPermissions(
                    this@RequestOld, arrayOf(Manifest.permission.RECORD_AUDIO),
                    0
                )
                false
            })
    ...
    private fun setVoice(audioPath: String) {
        ...
        binding.apply {
            audioPath?.toUri().let { uri ->
                mediaPlayer = MediaPlayer.create(this@RequestOld, audioPath?.toUri())
    ...
    private fun setRepairInfo() {
        binding.apply {
            viewModel.requested_serive_order?.let { service_order ->
                ...
                startActivity(
                    Intent(this@RequestOld, RequestDeliveryActivity::class.java)
                )
            }
        }
    }*/
