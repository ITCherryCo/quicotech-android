...
class Repository() {
    ...
    suspend fun register(registerBody: RegisterBodyParameters) =
        RetrofitInstance.api.register(registerBody)
    ...
    suspend fun getUser(session_id: String) = RetrofitInstance.api.getUser(session_id)
     ...
     suspend fun logout2(session_id:String) = RetrofitInstance.api.logout2(session_id)
     suspend fun logout() = RetrofitInstance.api.logout()

    suspend fun updateUserInfo(updateBody: UpdateUserBodyParameters) =
        RetrofitInstance.api.updateUserInfo(updateBody)

    suspend fun updateEmail(session_id: String, updateBody: UpdateUserBodyParameters) =
        RetrofitInstance.api.updateEmail(session_id, updateBody)
    ...
    //suspend fun getAddresses2(session_id:String) = RetrofitInstance.api.getAddresses(session_id)
    ...
    suspend fun termsAndConditions(store_id: Int) =
        RetrofitInstance.api.termsAndConditions(store_id)

    suspend fun services(store_id: Int, maintenance_id: Int) =
        RetrofitInstance.api.services(store_id, maintenance_id)

    suspend fun loadCart(store_id: Int, order_id: Int) =
        RetrofitInstance.api.loadCart(store_id, order_id)
